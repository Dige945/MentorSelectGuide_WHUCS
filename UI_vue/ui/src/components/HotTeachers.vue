<template>
  <div class="hot-teachers">
    <h2 class="section-title">热门导师推荐</h2>
    <el-row :gutter="20">
      <el-col :span="4.8" v-for="teacher in hotTeachers" :key="teacher.id">
        <el-card class="teacher-card" shadow="hover" @click="goToDetail(teacher.id)">
